...
describe("Customer Routes", () => {
    ...
    //         .send({ 'name': 'Jeff', 'lastName': 'Ament', 'birthDate': '1963/03/10', 'dniNumber': 12345678, 'dniLetter': 'R' })
    //         .then(res => {
    //             expect(res.get('Content-Type')).toEqual(expect.stringMatching('/json'));
    ...
    //             expect(res.body.data.birthDate).toBe("1963-03-09T23:00:00.000Z");
    //             expect(res.body.data.dniNumber).toEqual(12345678);
    //             expect(res.body.data.dniLetter).toBe("R");
    //         });
    // }, 10000);

    // //! A veces falla, parece que los test no se ejecutan en el orden en el cual están declarados
    ...
    //         .send({'name': 'User', 'lastName': 'Updated', 'birthDate': '1968/06/20', 'dniNumer': 17608824, 'dniLetter': 'Y'})
    //         .then(res => {
    //             expect(res.get('Content-Type')).toEqual(expect.stringMatching('/json'));
    //             expect(res.statusCode).toEqual(202);
    //             expect(res.body.data).toHaveProperty('id', 'name', 'lastName', 'birthDate', 'dniNumber', 'dniLetter');
    ...
    //             expect(res.body.data.birthDate).toBe("1968-06-19T23:00:00.000Z");
    //             expect(res.body.data.dniNumber).toEqual(68096750);
    //             expect(res.body.data.dniLetter).toBe("Y");
    //         });
    // }, 10000);
}, 10000);