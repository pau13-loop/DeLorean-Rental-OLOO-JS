...
describe("Category Routes", () => {
    ...
    //                     // expect.objectContaining({ MIN_PRICE_CATEGORY: 20 }),
    //                     // expect.objectContaining({ MIN_PRICE_CATEGORY: 25 })
    //                 ])
    //             );
    //             expect(res.body.data).toEqual(
    ...
    //                     expect.objectContaining({ name: 'common' }),
    //                     expect.objectContaining({ discountTax: 60 }),
    //                     // expect.objectContaining({ MIN_PRICE_CATEGORY: 15 })
    //                 ]));
    //         });
    // }, 10000);
    ...
    // CREATE 
//! Se crea antes de que se elimine la categoria premium
